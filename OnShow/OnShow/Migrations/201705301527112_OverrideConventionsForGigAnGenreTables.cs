namespace OnShow.Migrations
{
    ...
    public partial class OverrideConventionsForGigAnGenreTables : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Gigs", "Genre_Id", c => c.Guid(nullable: false));
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Gigs", new[] { "Genre_Id" });
            DropIndex("dbo.Gigs", new[] { "Artist_Id" });
            AlterColumn("dbo.Gigs", "Genre_Id", c => c.Guid());
